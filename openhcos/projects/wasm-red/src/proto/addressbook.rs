...
pub struct Person {
    ...
    pub status: ::protobuf::SingularPtrField<super::codes::AccountStatusCode>,
    // special fields
...
impl Person {
    ...
    // repeated .openhcos.Person.PhoneNumber phones = 4;
    ...
    // .google.fhir.stu3.proto.AccountStatusCode status = 6;
    ...
    // Param is passed by value, moved
    pub fn set_status(&mut self, v: super::codes::AccountStatusCode) {
        self.status = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_status(&mut self) -> &mut super::codes::AccountStatusCode {
    ...
    // Take field
    pub fn take_status(&mut self) -> super::codes::AccountStatusCode {
        self.status.take().unwrap_or_else(|| super::codes::AccountStatusCode::new())
    }

    pub fn get_status(&self) -> &super::codes::AccountStatusCode {
        self.status.as_ref().unwrap_or_else(|| super::codes::AccountStatusCode::default_instance())
    }
}
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::codes::AccountStatusCode>>(
                    "status",
                    |m: &Person| { &m.status },
                    |m: &mut Person| { &mut m.status },
                ));
...
impl Person_PhoneNumber {
    ...
    // .openhcos.Person.PhoneType type = 2;
...
impl AddressBook {
    ...
    // repeated .openhcos.Person people = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11addressbook.proto\x12\x08openhcos\x1a\x1fgoogle/protobuf/timestamp\
    .proto\x1a\x16proto/stu3/codes.proto\"\xfe\x02\n\x06Person\x12\x12\n\x04\
    name\x18\x01\x20\x01(\tR\x04name\x12\x0e\n\x02id\x18\x02\x20\x01(\x05R\
    \x02id\x12\x14\n\x05email\x18\x03\x20\x01(\tR\x05email\x124\n\x06phones\
    \x18\x04\x20\x03(\x0b2\x1c.openhcos.Person.PhoneNumberR\x06phones\x12=\n\
    \x0clast_updated\x18\x05\x20\x01(\x0b2\x1a.google.protobuf.TimestampR\
    \x0blastUpdated\x12A\n\x06status\x18\x06\x20\x01(\x0b2).google.fhir.stu3\
    .proto.AccountStatusCodeR\x06status\x1aU\n\x0bPhoneNumber\x12\x16\n\x06n\
    umber\x18\x01\x20\x01(\tR\x06number\x12.\n\x04type\x18\x02\x20\x01(\x0e2\
    \x1a.openhcos.Person.PhoneTypeR\x04type\"+\n\tPhoneType\x12\n\n\x06MOBIL\
    E\x10\0\x12\x08\n\x04HOME\x10\x01\x12\x08\n\x04WORK\x10\x02\"7\n\x0bAddr\
    essBook\x12(\n\x06people\x18\x01\x20\x03(\x0b2\x10.openhcos.PersonR\x06p\
    eopleb\x06proto3\
";
